...
And that's all! If you've read up to here, you'll feel much more comfortable dealing with dates and times in R. We haven't seen how to operate with them (addition and subtraction of 2 dates). [This will be another R recipe](How-to-add-and-subtract-Dates-and-Times-in-R.html).
